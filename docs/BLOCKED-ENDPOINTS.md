...
**44 of 336** registered endpoints are **not driven against the live app**.
...
| Needs setup we lack (business login 403, company logo 500) | 5 |
| Public record write (enquiry / unsubscribe) | 2 |
| **Total not tested on live** | **44** |
