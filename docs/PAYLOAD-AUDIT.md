...
| `POST /workplaceHierarchy/getWorkPlaceHierarchy` (`admin-workplace-hierarchy`) | id, attributeId, variableId, parentAttributeId, parentVariableId, reportingAttributeId, reportingVariableId, reportingParentAttributeId, reportingParentVariableId, workplaceJson, reportingJson, abbreviation, code |
